...
global z
mydb = mysql.connector.connect(user='Jagadishk', password='Sriram@33',
                               host='localhost',
                               database='dummy', auth_plugin='mysql_native_password')
mycursor = mydb.cursor()
A_name1=input("Enter name")
A_password=input("Enter password")
A_rpassword=input("Re-Enter password")
print(" --: Registration Successfull :-- " )
while True:
    A_name=input("Enter Username ")
    A_password=input("Enter Password ")
    if (A_name==A_name1 and A_password==A_rpassword):
